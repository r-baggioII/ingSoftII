...
export function AutoresPage() {
  ...
  const [current, setCurrent] = useState<AutorDTO>(emptyAutor);
  ...
  return (
    <section>
      <div className="actions" style={{ marginBottom: '1rem' }}>
        ...
        >
          {showForm && !isEditing ? 'Cerrar formulario' : 'Nuevo autor'}
        </button>
        {isEditing && (
          <button
            className="secondary"
                ...
                <tr key={autor.id}>
                  ...
                  <td>
                    <div className="table-actions">
                      <button className="secondary" onClick={() => setEditingId(autor.id!)}>
                        Editar
                      </button>
