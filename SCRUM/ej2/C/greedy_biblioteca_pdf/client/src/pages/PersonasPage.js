...
export function PersonasPage() {
    ...
    return (_jsxs("section", { children: [_jsxs("div", { className: "actions", style: { marginBottom: '1rem' }, children: [_jsx("button", { onClick: () => {
                        ...
                        }, children: showForm && !isEditing ? 'Cerrar formulario' : 'Nueva persona' }), isEditing && (_jsx("button", { className: "secondary", onClick: () => {
                            setEditing(null);
                            setShowForm(false);
                        }, children: "Cancelar edici\u00F3n" }))] }), (showForm || isEditing) && (_jsx(PersonaForm, { initialValue: formPersona, localidades: localidades, onSubmit: isEditing ? handleUpdate : handleCreate, onCancel: () => {
                    setEditing(null);
                    setShowForm(false);
