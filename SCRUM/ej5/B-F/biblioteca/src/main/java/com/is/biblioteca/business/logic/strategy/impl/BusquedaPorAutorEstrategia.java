...
@Component("busquedaPorAutorEstrategia")
public class BusquedaPorAutorEstrategia implements LibroBusquedaEstrategia {
    ...
    public List<Libro> buscar(String valor) throws ErrorServiceException {
        try {
            if (valor == null || valor.trim().isEmpty()) {
                throw new ErrorServiceException("Debe indicar el autor (ID)");
            }
            return libroRepository.listarLibroPorAutor(valor);
