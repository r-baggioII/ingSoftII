...
public class PersonaService {
    ...
    public PersonaDTO findById(Long id) {
        return toDto(requirePersona(id));
    }
    ...
    public PersonaDTO update(Long id, PersonaRequest request) {
        Persona persona = requirePersona(id);
        applyValues(persona, request);
        return toDto(personaRepository.save(persona));
    }

    public void delete(Long id) {
        personaRepository.delete(requirePersona(id));
    }
    ...
    private void applyValues(Persona persona, PersonaRequest request) {
        ...
        Localidad localidad = requireLocalidad(domicilioRequest.localidadId());
    ...
    private Localidad requireLocalidad(Long id) {
